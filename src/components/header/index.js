...
function Header() {
  ...
  const handleChange = (e) => {
    // Обновляем состояние formData с новыми данными из поля ввода
    setFormData({
    ...formData, // Сохраняем предыдущие данные
    [e.target.name]: e.target.value, // Обновляем значение нужного поля по его имени
    });
};
      ...
      <div className="container">
         <div className="header_one">
            ...
            <div className="register">
                ...
                <a className='signUP' href="#" onClick={() => setShowMenu(true)}>Зарегистрироваться</a>

              { showMenu && <div className="register_item">
                  <div className="register_block">
                    <div className="logo">
                      <img src="/img/logoIKT.png" alt="" />
                      <RiCloseCircleFill onClick={() => setShowMenu(false)}/>
                    </div>
                    <form action="" onSubmit={handleRegister}>
                      ...
                      <input onChange={handleChange} type="password" name='confirmPassword' /><br/>
                      <button className='register_button' type='submit'>Зарегистрироваться</button>
                      <p>----- Если есть учетная запись ...<a href="">Войти</a> ----------</p>
                    </form>
                  </div>
                </div>} 

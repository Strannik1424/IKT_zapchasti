  ...
  return (
    ...
    <div className="toyota_Lc200_Electric">
        <div className="container">
            ...
            <div className='detalInfo_title'>
            {props.detals.map((el) => (
                el.id == Number(id) ? <div key={el.id} className="text"><h1>{el.title}</h1></div> : null
            ))}
            <div>
                <button className='exp'>Перемещение товара</button>
                <button className='zag'>Загрузить Excel</button>
                <button className='skach'>Скачать Excel</button>
            </div>
            </div>
           {
                (() => {
    ...
    <div class="modal-content">
     ...
     {props.listDetals.map((el) => (
        ...
        <div class="carousel-inner">
            ...
            <img style={{height:'270px'}} src="/img/Запчасти/Шины/1.jpg" class="d-block w-100" alt="..." />
            </div>
            <div class="carousel-item" data-bs-interval="2000">
            <img style={{height:'270px'}} src="/img/Запчасти/Шины/2.webp" class="d-block w-100" alt="..." />
            </div>
            <div class="carousel-item">
            <img style={{height:'270px'}} src="/img/Запчасти/Шины/3.jpg" class="d-block w-100" alt="..." />
            </div>
        </div>
